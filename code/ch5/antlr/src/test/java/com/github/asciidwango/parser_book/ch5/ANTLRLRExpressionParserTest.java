...
public class ANTLRLRExpressionParserTest {
    @DisplayName("ANTLRで1をパースした結果が1になることをテストする")
    @Test
    public void test1() throws Exception {
        var parser = new LRExpressionParser(Main.streamFrom("1"));
    ...
    public void test2() throws Exception {
        var parser = new LRExpressionParser(Main.streamFrom("(1 + 2) * 3"));
    ...
    public void test3() throws Exception {
        var parser = new LRExpressionParser(Main.streamFrom("(1 + 2) * 4 / 3"));
